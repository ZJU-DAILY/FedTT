from traffic_model.stssl_model.lib.metrics import mae_torch
import os
import random
import torch
import numpy as np
...
# def masked_mae_loss_function(preds, labels, mask_value):
#     mae = mae_torch(pred=preds, true=labels, mask_value=mask_value)
#     return mae

# def masked_mae_loss(mask_value):
#     # 返回一个绑定了 mask_value 的部分应用函数
#     return partial(masked_mae_loss_function, mask_value=mask_value)
def masked_mae_loss(mask_value):
