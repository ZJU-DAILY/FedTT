...
from traffic_model.pdformer_model.dataset import TrafficStateDataset
...
class TrafficStateGridDataset(TrafficStateDataset):
    ...
    def __init__(self, config):
        ...
        self.cache_file_name = os.path.join(f'data/{self.dataset}/pdformer_cache/',
                                            'grid_based_{}.npz'.format(self.parameters_str))#好像没用到
        self._load_rel()
